...
<%@include file="/WEB-INF/views/template/adminHeader.jsp" %>
 ...
 <c:url var="firstUrl" value="/admin/productcategories/1" />
<c:url var="lastUrl" value="/admin/productcategories/${totalPages}" />
<c:url var="prevUrl" value="/admin/productcategories/${currentPageNumber - 1}" />
<c:url var="nextUrl" value="/admin/productcategories/${currentPageNumber + 1}" /> 
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="mainTable" class="display table table-bordered table-striped">
                  ...
                  <tr>
                  	<td>${productcategories.productCategoriesId}</td>
                  	
                  	<td>${productcategories.name}</td>
                  	<td>
                  	<div class="btn-group">
		              <a class="btn btn-info btn-xs" href="<spring:url value="/admin/productcategories/updateproductcategories/${productcategories.productCategoriesId}"/>"><i class="fas fa-edit"></i></a>
		              <a class="btn btn-info btn-xs" href="<spring:url value="/admin/productcategories/deleteproductcategories/${productcategories.productCategoriesId}"/>"><i class="fas fa-trash-alt"></i></i></a>
                  	</div>
                  	</td>
                  </tr>
                  </c:forEach>
                  ...
                  <div class="col-sm-12 col-md-5">
                  	<ul class="pagination pagination-sm float-left">
				        ...
				        <c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
				            <c:url var="pageUrl" value="/admin/productcategories/${i}" />
				            <c:choose>
