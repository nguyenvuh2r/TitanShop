      ...
      <div class="container-fluid">
	   ...
	   <section class="content">
		...
		<div class="form-layout">
	       <form:form modelAttribute="categories"  action="${pageContext.request.contextPath}/admin/productcategories/updateproductcategories?${_csrf.parameterName}=${_csrf.token}"  class="form-horizontal"  >
				...
				<div class="form-group has-success">
					<label class="col-xs-3 control-label" for="productName">Categories Name :</label>
					<div class="col-xs-9">
